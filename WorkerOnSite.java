...
public class WorkerOnSite extends Worker {
	...
	public WorkerOnSite(String nameFirst, String nameLast, int pricePerHour) {
	...
	public int calculateWage(int hoursMonth) {
		return super.calculateWage(hoursMonth) + petrol;
	}
	...
	public String printWage() {
		return "Deprecated method in onsite worker";
	}
